...
atenção em uma solução, e não em uma escolha arbitrária.
...
O primeiro é o esquecimento. Considere o trecho ``A Inglaterra é minha terra
...
dependências de longo alcance. Arquiteturas posteriores, como as redes LSTM
...
O segundo é a lentidão, como cada
...
modernas, que é executar milhares de operações ao mesmo tempo. 
% A analogia é a de um
